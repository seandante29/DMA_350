...
module reserved_bits_tb ;
    ...
    //---checking for reseverd bits error
        ...
        //-----------change the srctranscfg due to reserved bit error and clear stat_error using enablecmd
        //CH_SRCTRANSCFG
    ...
    // comand descriptor1 // case2 des > 0 and src = 0;
        ...
        RDATA_I = 32'h0001ABCF; //link addr        ///-reseverved bit error 
        RLAST = 1;
        #10 RLAST= 0;
        RVALID=0;
        
        #200;
         //-----------change the link addr due to reserved bit error and clear stat_error using enablecmd
        //link addr
        ...
        #100; /// minimum 10 cycle delays should be given after last apb updation 
