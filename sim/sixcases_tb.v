...
module top_tb ;
    ...
    // comand descriptor1 // case2 des > 0 and src = 0;
    ...
    // comand descriptor2 // case 4: des = src
    ...
    // command descriptor3 // case 5 : src > des
        ...
        RDATA_I = 32'h00000200;#10//destrig
        RDATA_I = 32'h00000200;#10//trigout
        RDATA_I = 32'h0003ABC1; //link addr
        RLAST = 1;
        #10 RLAST= 0;
        RVALID=0;
   ...
   // command descriptor 4 // case 6 : des > src ; xtype = fill
        #60;
        ARREADY = 1'b1;
        #20 ARREADY = 1'b0;
    ...
    // command descriptor 5 // case 6 : des > src ; xtype = wrap
        #60;
        ARREADY = 1'b1;
        #20 ARREADY = 1'b0;
        ...
        RVALID =1;
        RDATA_I = 32'h70F; #10//intren
        RDATA_I = 32'h0E001400;#10//ctrl : xtype - wrap
        RDATA_I = 32'h1234;#10//src addr
        RDATA_I = 32'h5687;#10//des addr
        RDATA_I=32'h00060002;#10//xsize
        RDATA_I=32'h0;#10//trans cfg
    ...
    // command descriptor 6 // case 6 : des > src ; xtype = continue
        #60;
        ARREADY = 1'b1;
        #20 ARREADY = 1'b0;
        ...
        RVALID =1;
        RDATA_I = 32'h70F; #10//intren
        RDATA_I = 32'h0E001200;#10//ctrl : xtype - continue
        RDATA_I = 32'h1234;#10//src addr
        RDATA_I = 32'h5687;#10//des addr
        RDATA_I=32'h00060002;#10//xsize
        RDATA_I=32'h0;#10//trans cfg
    ...
    // command descriptor 7 // case 1 : des = src = 0
        #60;
        ARREADY = 1'b1;
        #20 ARREADY = 1'b0;
    ...
    // command descriptor 8 // case 3 : des = 0 src > 0
        #60;
        ARREADY = 1'b1;
        #20 ARREADY = 1'b0;
