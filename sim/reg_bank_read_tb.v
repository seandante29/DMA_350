...
module reg_bank_read_tb ;
    ...
    initial begin
      ...
      #30; //SRCADDR   minimum 3 cycles requied after enable cmd
        ...
        # 100;
        ///--------- CHECKING WHETHER REGIATERS ARE WRITTEN WHEN ENABLECMD IS HIGH
                //SRCADDR
        ...
        RDATA_I = 32'hACDB;#10//src addr
        RDATA_I = 32'h5687;#10//des addr
        RDATA_I=32'h00020000;#10//xsize
