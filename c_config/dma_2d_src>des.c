...
Xil_Out32(BRAM3_BASE + 60 , 0X00060004);               // ysize
...
Xil_Out32(BRAM3_BASE + 32 , 0X00060008);      // XSIZE(00080008)
...
Xil_Out32(BRAM3_BASE + 256 + 32 , 0X00060008); // XSIZE(00080008)
...
Xil_Out32(BRAM3_BASE + 512 + 32 , 0X00060008); // XSIZE(00080008)
Xil_Out32(BRAM3_BASE + 512 + 24 , 0xCE000000); // desaddr
Xil_Out32(BRAM3_BASE + 512 + 16 , 0xCC000000); // srcaddr
Xil_Out32(BRAM3_BASE + 512 + 12 , 0X0E203612); // CH_CTRL
