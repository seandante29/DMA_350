...
module apb_reg #(parameter DATA_WIDTH = 32,
     ...
     (
        ...
        output wire PREADY,
        output wire PSLVERR,
        output wire [WIDTH-1 : 0] cfg_channel_start,
        ...
        output wire [WIDTH-1 : 0] cfg_next_cmd_addr,
        ...
        output wire chn_cmd_wr_en_o, chn_stat_wr_en_o, chn_intren_wr_en_o,
            ...
            chn_trigout_wr_en_o,chn_next_cmd_addr_wr_en_o,chn_autocfg_wr_en_o,chn_work_reg_pointer_wr_en_o,chn_tmpltcfg_wr_en_o,chn_destmplt_wr_en_o,
            chn_srctmplt_wr_en_o,chn_yaddrestride_wr_en_o,chn_y_transfer_count_wr_en_o,
