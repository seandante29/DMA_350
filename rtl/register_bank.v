module register_bank #(parameter WIDTH = 32,
     ...
     (input wire clk,
      ...
      input wire [(WIDTH*14)-1 : 0] chn_reg_in,// from channel
      ...
      chn_trigout_wr_en_o,chn_linkaddr_wr_en_o,chn_wrkregptr_wr_en_o,chn_tmpltcfg_wr_en_o,chn_destmplt_wr_en_o,chn_srctmplt_wr_en_o,//to channel   ,// to mux logic
    ...
    assign chn_wrkregptr_wr_en_o =  cfg_wr_en && ( addr_w == 8'h8C);
