module data_fsm #(
   ...
   input wire [15:0] des_ysize  
    ...
    reg [15:0] src_yaddr_stride_reg;
     reg [15:0] des_yaddr_stride_reg;
            ...
            case (rd_state)
                ...
                RD_WAIT: begin
                 ...
                 //  src_addr_reload <= (restart_cnt_reg == 0)?SRC_ADDR:src_addr_reload;
                   ...
                   src_yaddr_stride_reg <= src_yaddr_stride;  // initalize yaddr stride here
    ...
    if (!resetn) begin
       ...
       fifo_rptr   <= 0;
        ...
        if( l == des_tmplt_size )
            ...
            case (wr_state)
                W_IDLE: begin
                des_yaddr_stride_reg <= des_yaddr_stride;
